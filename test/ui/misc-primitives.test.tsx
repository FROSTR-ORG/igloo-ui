...
describe('AppHeader', () => {
  it('renders title and subtitle', () => {
    render(<AppHeader title="igloo" subtitle="threshold signer" />);
    expect(screen.getByRole('heading', { name: 'igloo' })).toBeInTheDocument();
    expect(screen.getByText('threshold signer')).toBeInTheDocument();
  });

  it('renders the logo with an accessible alt', async () => {
    const { container } = render(<AppHeader title="igloo" logoSrc="/logo.png" logoAlt="FROSTR" />);
